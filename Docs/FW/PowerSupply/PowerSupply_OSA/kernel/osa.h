...
//------------------------------------------------------------------------------
    ...
    #define _OS_bTaskReady              ((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->bReady
    #define _OS_bTaskCanContinue        ((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->bCanContinue
    #define _OS_bTaskDelay              ((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->bDelay
    #define _OS_bTaskTimeout            (!((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->bDelay)
    #define _OS_bTaskEnable             ((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->bEnable
    #define _OS_cTaskPriority           ((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->cPriority
    #define _OS_bTaskPaused             ((OS_RAM_NEAR OST_TASK_STATE*)(&INDF0))->bPaused
